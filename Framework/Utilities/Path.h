...
public:
	...
	static void OpenFileDialog(wstring file, const WCHAR* filter, wstring folder, uint num, Material* material,function<void(wstring, uint,Material*)> func, HWND hwnd = NULL);
