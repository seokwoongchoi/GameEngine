...
void Shader::Pass::DrawInstancedIndirect(ID3D11Buffer * buffer, uint offset)
{
	BeginDraw();
	{
		D3D::GetDC()->DrawInstancedIndirect(buffer, offset);
	}
	EndDraw();
}
...
void Shader::Technique::DrawInstancedIndirect(UINT pass, ID3D11Buffer * buffer, uint offset)
{
	Passes[pass].DrawInstancedIndirect(buffer, offset);
}
...
void Shader::DrawInstancedIndirect(UINT technique, UINT pass, ID3D11Buffer * buffer, UINT offset)
{
