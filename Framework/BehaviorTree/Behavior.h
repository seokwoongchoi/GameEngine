...
//{
	...
	public:
		...
		virtual EStatus Update(const uint& instanceIndex) = 0;
	...
	public:
		...
		void SetIsSeeEnemy(bool condition);
		
		void SetIsHealthLow(bool condition);
		
		void SetIsEnemyDead(bool condition);
	
	public:
		EStatus Tick(const uint& instanceIndex);
	...
	protected:
		...
		virtual EStatus Update(const uint& instanceIndex)override;
